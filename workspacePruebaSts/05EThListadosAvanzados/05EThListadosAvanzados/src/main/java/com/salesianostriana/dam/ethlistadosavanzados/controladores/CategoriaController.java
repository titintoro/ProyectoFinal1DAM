...
public class CategoriaController {
	...
	//(ojo, la barra última tb, ya que esta es la petición que atiende este método index, pero debemos escribir antes
	...
	public String index(Model model) {
		...
		//está dentro de templates (nuestra raiz) tenemos que poner la ruta desde templates, es decir,
		//debemos "entrar en admin" y luego dar el nombre del archivo del html a mostrar.
