...
public class Application {
	...
	/**
	 * Este método, que se ejecutará al iniciar el proyecto nos servirá 
	 * de soporte para que todos los productos de nuestro sistema 
	 * tengan una puntuación (más o menos) aleatoria, 
	 * simulando el que haya sido puntuado por cientos
